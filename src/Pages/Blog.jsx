...
const ROOT = "https://api.biddius.com";
...
const Blog = () => {
  ...
  const fallbackPosts = [
    {
      ...
      date: "Oct 15, 2025",
      readTime: "8 min read",
      description: "Discover the latest techniques and strategies to maximize your success in online auctions. Learn from industry experts and real-world case studies.",
      image: imageTwo,
    ...
    },
    {
      ...
      date: "Oct 20, 2025",
      readTime: "6 min read",
      description: "Timing your bids perfectly can make a big difference in auctions. Here's how to plan your strategy for maximum efficiency.",
      image: imageTwo,
      content: "Full content here..."
    },
    {
      ...
      date: "Oct 25, 2025",
      readTime: "5 min read",
      description: "Stay informed about the latest changes in auction platform fees and how to make them work to your advantage.",
      image: imageTwo,
      content: "Full content here..."
    },
  ];
  ...
  const getSafeDisplayPosts = () => {
    ...
    if (safePosts.length <= 1) {
      return fallbackPosts.slice(1);
    }
    return safePosts.slice(1);
  };
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        ...
        const response = await fetch(`${ROOT}/api/blogs`);
    ...
    <div className="bg-[#F2F0F1] min-h-screen py-10 px-4 md:px-20">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-700 mb-8">
          Insights, strategies, and updates from the world of online auctions and bidding.
        </p>
        ...
        <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition duration-300 overflow-hidden border border-gray-200 mb-16">
          <div className="grid md:grid-cols-2">
            <div className="w-full h-full">
              <img
                src={currentFeaturedPost.image || imageOne}
            ...
            <div className="p-8 flex flex-col justify-center">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                {currentFeaturedPost.description || currentFeaturedPost.content?.substring(0, 150) + "..."}
              </p>

              <div className="flex items-center text-gray-500 text-sm gap-4 mb-4">
                <div className="flex items-center gap-1">
                  <Calendar className="w-4 h-4" />
                  <span>{formatDate(currentFeaturedPost.created_at || currentFeaturedPost.date)}</span>
                </div>
                <div className="flex items-center gap-1">
                  <Clock className="w-4 h-4" />
                  <span>{calculateReadingTime(currentFeaturedPost.content)}</span>
                </div>
              </div>
