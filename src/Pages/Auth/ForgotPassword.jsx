...
const ForgotPassword = () => {
  ...
  return (
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-2 bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6"> 
        ...
        {message && <p className="text-red-800 font-bold text-center mb-2 text-sm">{message}</p>}
        {error && <p className="text-red-600 font-bold text-center mb-2 text-sm">{error}</p>}
